                        ...
                        <div class="card-body pb-1">
                            ...
                            <div class="row">
                                <div class="col-md-5 py-3">
                                    <img src="https://dummyimage.com/1098x538/dee2e6/6c757d.jpg" class="img-fluid"
                                        width="100%" style="max-height: 200px" id="preview-image">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="tagIds" name="tag_ids[]"
                                            class="form-control @error('tag_ids') is-invalid @enderror" multiple="multiple">
                                            @foreach ($tags as $tag)
